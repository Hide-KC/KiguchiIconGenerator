...
class MainActivity : AppCompatActivity(), PartsGridFragment.OnPartsClickListener, ControllerFragment.OnKeyClickedListener, IconViewFragment.OnIconUpdatedListener, CommentFragment.ICommentUpdate, ColorChangeListener {
    ...
    enum class FragmentTag(tag: String){
        CONTROLLER("controller"), PARTS_GRID("parts_grid"), ICON_VIEW("icon_view"), COLOR_PICKER("color_picker")
    }
...
//        toolbar.setNavigationIcon(android.R.drawable.)
        ...
        groupAdapter.add(R.drawable.ic_comment_000_tint)
        ...
        groupList.setOnItemClickListener { adapterView: AdapterView<*>, view1: View, i: Int, l: Long ->
            ...
            if (swapFragmentState == FragmentTag.PARTS_GRID) {
                ...
                if (g == IconLayout.GroupEnum.COMMENT){
                    transaction.replace(R.id.swap_layout, CommentFragment.newInstance(null))
                } else {
        ...
        iv.setOnClickListener{ v: View ->
            ...
            dialog.show(this.supportFragmentManager, FragmentTag.COLOR_PICKER.name)
        }
